#!/bin/bash
#SBATCH --job-name=topo-prefill-isobudget-deepseek
...
#SBATCH --output=/storage/scratch1/8/syoon351/repos/LLMServingSim/outputs/panel_dse/slurm_isobudget_deepseek_%j.out
#SBATCH --error=/storage/scratch1/8/syoon351/repos/LLMServingSim/outputs/panel_dse/slurm_isobudget_deepseek_%j.err
...
apptainer exec --cleanenv \
  ...
  --pwd "$REPO" "$SIF" bash -c "
    ...
    cd $REPO
    bash scripts/run_topo_prefill_hpc.sh
  "
