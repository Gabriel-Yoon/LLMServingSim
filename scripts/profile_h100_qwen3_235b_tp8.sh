#!/bin/bash
# TP=8 profiling — Qwen/Qwen3-235B-A22B on H100 (ViBE-aligned TP=8+EP=8).
# Skew is SEPARATED into two passes (run pass 1, then pass 2):
#   SKIP_SKEW=1 scripts/profile_h100_qwen3_235b_tp8.sh   # pass 1: dense/attention/moe (fast)
#   ONLY_SKEW=1 scripts/profile_h100_qwen3_235b_tp8.sh   # pass 2: skew sweep + alpha fit
