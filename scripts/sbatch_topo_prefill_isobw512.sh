#!/bin/bash
#SBATCH --job-name=topo-prefill-isobw512
...
#SBATCH --output=/storage/scratch1/8/syoon351/repos/LLMServingSim/outputs/panel_dse/slurm_isobw512_%j.out
#SBATCH --error=/storage/scratch1/8/syoon351/repos/LLMServingSim/outputs/panel_dse/slurm_isobw512_%j.err
...
apptainer exec \
  ...
  bash -c "
    ...
    cd /storage/scratch1/8/syoon351/repos
    ln -sfn LLMServingSim/profiler profiler
    cd $REPO
    EQBW=512 bash scripts/run_topo_prefill_hpc.sh
  "
